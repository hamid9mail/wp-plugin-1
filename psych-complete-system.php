...
final class Psych_Complete_System_Enhanced {
    ...
    private function load_modules() {
        $modules_to_load = [
            ...
            // مسیر جدید برای موتور مأموریت
            'mission-engine.php'         => 'Psych_Advanced_Mission_Engine_Core',
        ];
    ...
    private function initialize_modules() {
        $initialization_order = [
            ...
            // موتور مأموریت باید قبل از محتوای تعاملی راه‌اندازی شود
            'mission_engine'      => 'Psych_Advanced_Mission_Engine_Core',
